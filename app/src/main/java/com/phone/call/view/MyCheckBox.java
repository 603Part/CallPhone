...
import com.phone.call.utils.CompatUtils;
...
public class MyCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        int tickColor = ta.getColor(R.styleable.MyCheckBox_color_tick, COLOR_TICK);
        mAnimDuration = ta.getInt(R.styleable.MyCheckBox_duration, DEF_ANIM_DURATION);
        mFloorColor = ta.getColor(R.styleable.MyCheckBox_color_unchecked_stroke, COLOR_FLOOR_UNCHECKED);
        mCheckedColor = ta.getColor(R.styleable.MyCheckBox_color_checked, COLOR_CHECKED);
        mUnCheckedColor = ta.getColor(R.styleable.MyCheckBox_color_unchecked, COLOR_UNCHECKED);
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.MyCheckBox_stroke_width, CompatUtils.dp2px(getContext(), 0));
        ta.recycle();
